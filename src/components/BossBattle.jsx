...
// ✨ App.jsx에서 onSelectBattle을 받아옵니다.
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-start bg-black text-white pt-6 px-4 select-none touch-manipulation">
      ...
      {previewBossId && pBoss && partyData && (
        <div 
          className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-[fadeIn_0.2s_ease-out]" 
        ...
        >
          ...
          <div 
            ...
            style={{ animation: 'modalBreathe 3s ease-in-out infinite' }} 
          >
            
            <div className="relative w-full h-24 bg-black flex items-end"> 
              <div 
            ...
            <div className="px-5 py-4 flex flex-col gap-4 bg-gradient-to-b from-[#0a0705] to-black">
              ...
              <div className="flex flex-col gap-2.5">
                <div className="flex justify-between items-center border-b border-white/5 pb-1.5">
                  ...
                  <div className="flex gap-3 text-[10px] font-black tracking-wider">
                    <span className="text-[#d8b486]">ATK {minAtk}~{maxAtk}</span> 
              ...
              {/* ✨ Challenge 클릭 시 App.jsx로 넘겨 로딩화면을 띄움! */}
              <button 
                onClick={() => {
                  onSelectBattle(previewBossId); 
                  setPreviewBossId(null);
                }}
                className="mt-2 w-full bg-[#110a08] hover:bg-red-950/40 text-red-500/70 font-serif font-black text-[10px] py-2.5 rounded-sm transition-colors shadow-inner active:scale-95 uppercase tracking-[0.3em]"
              >
                Challenge
              </button>
