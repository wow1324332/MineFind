...
// 💡 경로 수정됨: 모든 이미지를 public/avatars/ 폴더 안에서 불러옵니다.
const AVAILABLE_AVATARS = [
  { id: 'apprentice1', src: '/avatars/knight1.jpeg', name: '견습 기사' },
  { id: 'apprentice2', src: '/avatars/knight2.jpeg', name: '견습 기사' },
  { id: 'apprentice3', src: '/avatars/knight3.jpeg', name: '견습 기사' },
  // 방금 생성한 견습 기사 이미지가 있다면 파일명을 맞춰 아래처럼 추가할 수 있습니다.
  // { id: 'apprentice', src: '/avatars/avatar-apprentice.png', name: '견습 기사' },
];
